...
# under the License.
#
from lib.checker import wait_for_storage_class_is_away
from lib.common import AbstractCommand, choose_context_and_namespace, ArgumentConfig
from lib.confirmer import confirm_storage_class, confirm
from lib.remover import remove_storage_class

# DO NOT TOUCH! this file is auto-generated and will be overwritten. Use templates/action_removal.py.j2


class DropStorageClass(AbstractCommand):

    def get_command(self) -> str:
        return "drop storage_class"
