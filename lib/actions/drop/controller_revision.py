...
# under the License.
#
from lib.checker import wait_for_controller_revision_is_away
from lib.common import AbstractCommand, choose_context_and_namespace, ArgumentConfig
from lib.confirmer import confirm_controller_revision, confirm
from lib.remover import remove_controller_revision

# DO NOT TOUCH! this file is auto-generated and will be overwritten. Use templates/action_removal.py.j2


class DropControllerRevision(AbstractCommand):

    def get_command(self) -> str:
        return "drop controller_revision"
    ...
    def run(self, args):
        ...
        if args.controller_revision:
            remove_controller_revision(context, namespace, args.controller_revision)
            wait_for_controller_revision_is_away(context, namespace, args.controller_revision)
        else:
            obj = confirm_controller_revision(context, namespace)
            if obj is not None and confirm("Do you really want to delete ControllerRevision " + obj + " in namespace " + namespace + "?"):
